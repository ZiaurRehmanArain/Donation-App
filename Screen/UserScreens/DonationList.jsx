...
function DonationList() {
    ...
    const fetchData = async () => {
      try {
        const snapshot = await firestore()
          .collection('Donation') // Replace 'yourCollection' with your actual Firestore collection name
  ...
  return (<View style={{ flex: 1 }}>
    <View>
      <Text style={{ fontSize: 20, textAlign: 'center', color: 'black' }}>Donation List</Text>
    </View>
